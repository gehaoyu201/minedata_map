    ...
    <el-form label-position="left" label-width="40px">
      <el-tabs v-model="activeName" @tab-click="tabClick">
        <el-form-item>
          ...
          <el-button @click="delExample" v-if="!flag">删除当前加载数据</el-button>
        </el-form-item>
        <div v-if="!flag">
          <div class="block">
...
export default {
  ...
  data() {
    return {
      ...
      pointJsonData: null, //点的数据源
      lineJsonData: null, //线的数据源
  ...
  methods: {
    ...
    handleClick() {
      ...
      if (this.activeName == "first") {
        ...
        let coors = this.split.parseCoors(this.lineData);
        let obj = this.split.initSplitLineData(
          coors,
          "kilometers",
          this.splitLength
        );
